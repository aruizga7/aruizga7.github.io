$(document).ready(function() {
  ...
  var forked = 0;
  var repos = [];
  var org = new Organization('aruizga7', []);

  $.get('https://api.github.com/users/aruizga7/repos?per_page=100', function(data) {
    ...
    $.get('https://api.github.com/orgs/aruizga7/members', function(data) {
